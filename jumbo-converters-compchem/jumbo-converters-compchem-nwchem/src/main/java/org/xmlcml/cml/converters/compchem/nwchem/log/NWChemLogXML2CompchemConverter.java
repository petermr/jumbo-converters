...
public class NWChemLogXML2CompchemConverter extends XML2XMLTransformConverter {
	...
	private NWChemLogXML2CompchemConverter() {
	}
	
	public static NWChemLogXML2CompchemConverter createDefaultConverter() {
		return  new NWChemLogXML2CompchemConverter(BASE_URI, "nwchem2compchem.xml");
	}
